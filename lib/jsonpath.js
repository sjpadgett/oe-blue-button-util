...
var jsonPathMethods = {
    ...
    traceProperties: function (properties, index, obj, jspResult) {
        if (properties) {
            properties.forEach(function (p) {
                ...
                this.traceProperty(p, index, obj, newJspResult);
            }, this);
        }
    },
    traceProperty: function (property, index, obj, jspResult) {
        if (obj && obj.hasOwnProperty(property)) {
            ...
            this.traceNext(index, obj[property], jspResult);
        }
    },
    traceAll: function (index, obj, jspResult) {
        var rootJspResult = jspResult.clone();
        this.traceNext(index, obj, rootJspResult);
        var ps = properties(obj);
        if (ps) {
        ...
        if (ps) {
            ps.forEach(function (p) {
                ...
                this.traceAll(index, obj[p], newJspResult);
            }, this);
        }
    },
    traceBack: function (index, obj, jspResult) {
        jspResult.back();
        this.traceNext(index, jspResult.currentObject(), jspResult);
    },
    ...
    traceNext: function (index, obj, jspResult) {
        ...
        action.call(this, index, obj, jspResult);
    },
...
var exprToJsonPathMethod = {
    jsExprProperty: function (expr) {
        return function (index, obj, jspResult) {
            ...
            this.traceProperty(property, index, obj, jspResult);
        };
    },
    filteredProperties: function (expr) {
        ...
        return function (index, obj, jspResult) {
            ...
            this.traceProperties(ps, index, obj, jspResult);
        };
    },
    commaDelimitedProperties: function (expr) {
        var properties = expr.split(',');
        return function (index, obj, jspResult) {
            this.traceProperties(properties, index, obj, jspResult);
        };
    },
    arrayRange: function (expr) {
        ...
        return function (index, obj, jspResult) {
            ...
            this.traceProperties(range, index, obj, jspResult);
        };
    },
    ...
    objFunction: function (fn, expr) {
        return function (index, obj, jspResult) {
            ...
            this.traceNext(index, fn(obj), jspResult);
        };
    }
};
...
exports.instance = function (inputExpr, opts) {
    ...
    return function (obj) {
        ...
        jspResult.init(obj, '$');
        jsonPath.traceNext(-1, obj, jspResult);
