...
var jsonPathMethods = {
    ...
    allProperties: function (actions, obj, path, result) {
        ...
        this.traceProperties(ps, actions, obj, path, result);
    },
