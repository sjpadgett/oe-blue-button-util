...
exports.instance = function (inputExpr, opts) {
    ...
    actions.push(Tracer.traceEnd);
    if (actions[0] !== Tracer.traceStart) {
        actions.unshift(Tracer.traceStart);
    }

    return function (obj) {
        var jsonPath = Object.create(Tracer);
        ...
        jsonPath.run(accumulator);
        var ret = accumulator.result;
